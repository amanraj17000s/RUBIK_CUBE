...
/*
 this is a base class for every model and every solver 
 solver like bfs,dfs,idstar...
 it consist of properties like all faces,colour,and moves and fundamental function
...
public:
  // there are six faces 
   ...
   // 18 total moves are possible in the rubik cube include both clockwise and anti
    enum class MOVE {
        L, LPRIME, L2,
        R, RPRIME, R2,
        U, UPRIME, U2,
     ...
     * @parameter- Face, row, and column index
     */
    virtual COLOR getColor(FACE face, unsigned row, unsigned col) const = 0;

    /*
     * Returns the first letter of the given COLOR of cubie
